...
const themes: { id: ThemeName; label: string; icon: typeof Sun }[] = [
  ...
  { id: 'menu-default', label: 'Kadim Levha', icon: ScrollText },
]
...
export function ThemeSwitcher() {
  ...
  return (
    <details className="relative">
      ...
      <div className="legend-menu absolute right-0 top-full z-30 mt-2 flex min-w-40 flex-col gap-1 rounded-md border border-border bg-popover p-2">
